  ...
  const handleSave = () => {
    if (!title.trim()) {
      toast({
        ...
        description: "Please enter a title for your wiki page.",
        variant: "destructive",
      });
      return;
    }

    // Generate a simple ID for the new page
    ...
    router.push(`/workspace/idea-wiki/${newPageId}`);
  };

  const handleCancel = () => {
    router.push("/workspace/idea-wiki");
  };
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 md:py-0 transition-all duration-300">
        ...
        <div className="w-full max-w-3xl mx-auto bg-black/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/10 p-8 flex flex-col">
          <header className="mb-6 flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold flex-grow text-white">Create New Wiki Page</h1>
          </header>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-end">
              ...
              >
                <Save className="h-4 w-4 mr-1" /> Create Page
              </Button>
            </div>
          </div>
        </div>
...
export default NewWikiPagePage;
