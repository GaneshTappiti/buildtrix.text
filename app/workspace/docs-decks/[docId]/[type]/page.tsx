...
const DocumentEditorWithTypePage = () => {
  ...
  useEffect(() => {
    ...
    if (documentData.type === "deck") {
      // Initialize with one slide for deck type
      if (slides.length === 0) {
        setSlides([{
          id: "1",
          title: "Title Slide",
          content: "# Welcome to Your Presentation\n\nStart creating your slides here...",
          type: "title",
          layout: "default"
        }]);
      }
    } else {
      setContent("# Your Document Title\n\nStart writing your content here...");
    }
  }, [docId, type]);
  ...
  const handleBack = () => {
    router.push(documentData.type === "deck" ? "/workspace/pitch-perfect" : "/workspace/docs-decks");
  };
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <Button
              variant="ghost"
              onClick={handleBack}
              className="sm:mr-4 text-gray-400 hover:text-white hover:bg-white/10"
            >
              ...
              {documentData.type === "deck" && (
                <>
                  <Button
                    ...
                    className="flex-1 sm:flex-none border-white/20 bg-white/5 hover:bg-white/10 text-white hover:text-white"
                  >
          ...
          {/* Content Area - Same as the main DocumentEditor */}
          {documentData.type === "deck" ? (
                ...
                <Card className="bg-black/80 backdrop-blur-xl border-white/10">
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between text-white">
                      <span>Slides</span>
                      <Button size="sm" onClick={addNewSlide} className="bg-green-600 hover:bg-green-700">
                    ...
                    <CardContent>
                      {isPreviewMode ? (
                        ...
                        <Textarea
                          ...
                          className="min-h-[60vh] bg-black/20 border-white/10 text-white font-mono focus:border-green-400 focus:ring-green-400/20"
                ...
                <Card className="bg-black/80 backdrop-blur-xl border-white/10">
                  <CardContent className="p-6">
                    <Textarea
                      ...
                      className="min-h-[70vh] bg-black/20 border-white/10 text-white font-mono focus:border-green-400 focus:ring-green-400/20"
                ...
                <Card className="bg-black/80 backdrop-blur-xl border-white/10">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Button className="w-full border-white/20 bg-white/5 hover:bg-white/10 text-white hover:text-white" variant="outline">
        ...
        <Dialog open={isAIAssistantOpen} onOpenChange={setIsAIAssistantOpen}>
          <DialogContent className="bg-black/90 backdrop-blur-xl border-white/10 text-white">
            ...
            <div className="space-y-4">
              <div>
                <Label className="text-white">What would you like me to help you with?</Label>
                <Textarea
                  value={aiPrompt}
                  ...
                  className="bg-black/20 border-white/10 text-white focus:border-green-400 focus:ring-green-400/20"
                  rows={3}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button
                  variant="outline"
                  onClick={() => setAiPrompt("Write a compelling problem statement")}
                  className="border-white/20 bg-white/5 hover:bg-white/10 text-white hover:text-white"
                >
                  Problem Statement
                </Button>
                <Button
                  variant="outline"
                  onClick={() => setAiPrompt("Create a solution overview")}
                  className="border-white/20 bg-white/5 hover:bg-white/10 text-white hover:text-white"
                >
                  Solution Overview
                </Button>
                <Button
                  variant="outline"
                  onClick={() => setAiPrompt("Describe the market opportunity")}
                  className="border-white/20 bg-white/5 hover:bg-white/10 text-white hover:text-white"
                >
                  Market Opportunity
                </Button>
                <Button
                  variant="outline"
                  onClick={() => setAiPrompt("Explain the business model")}
                  className="border-white/20 bg-white/5 hover:bg-white/10 text-white hover:text-white"
                >
                  Business Model
                </Button>
...
export default DocumentEditorWithTypePage;
